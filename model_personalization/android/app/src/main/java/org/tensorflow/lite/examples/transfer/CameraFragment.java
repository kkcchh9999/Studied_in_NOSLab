...
public class CameraFragment extends Fragment {
  ...
  private final ImageAnalysis.Analyzer inferenceAnalyzer =
      (imageProxy, rotationDegrees) -> {
        ...
        if (sampleClass != null) {
          ...
          Log.d("체크 필수", String.valueOf(rgbImage.length));
  ...
  private String getClassNameFromResourceId(int id) {
    ...
    if (id == R.id.class_btn_1) {
      ...
      className = "3";
    } else if (id == R.id.class_btn_5) {
      className = "4";
    } else if (id == R.id.class_btn_6) {
      className = "5";
    } else if (id == R.id.class_btn_7) {
      className = "6";
    } else if (id == R.id.class_btn_8) {
      className = "7";
    } else if (id == R.id.class_btn_9) {
      className = "8";
    } else if (id == R.id.class_btn_10) {
      className = "9";
    } else {
  ...
  public void onCreate(Bundle bundle) {
    ...
    try {
      InputStream inputStream_label = assetManager.open("label.csv");
      ReadCSV read_label = new ReadCSV(inputStream_label);
      List<String[]> label_list = read_label.read();

      InputStream inputStream_mnist = assetManager.open("mnist.csv");
      ReadCSV read_mnist = new ReadCSV(inputStream_mnist);
      List<String[]> mnist_list = read_mnist.read();
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle bundle) {
    ...
    for (int buttonId : new int[] {
        R.id.class_btn_1, R.id.class_btn_2, R.id.class_btn_3, R.id.class_btn_4, R.id.class_btn_5, R.id.class_btn_6, R.id.class_btn_7, R.id.class_btn_8, R.id.class_btn_9, R.id.class_btn_10}) {
